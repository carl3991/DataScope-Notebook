...
plt.figure(figsize=(9, 5))
sns.scatterplot(x=y_test, y=residuals, color='green', edgecolor='black')
...
plt.title("Feature Importances (Sorted)", fontsize=17)
...
# The model relies most heavily on year and engine size.
